...
/**
 * @remarks Load the file and specify the location
 */
const swaggerJsDocs = YAML.load("./view/api.yaml")

/**
 * @remarks For Nodemon to watch YML file we need to add nodemon.json file in the root directory
 *and include the extensions
 */
app.use("/api-docs", swaggerUI.serve, swaggerUI.setup(swaggerJsDocs))

/**
 * @remarks create a route to hande POSt reques to /upload path and confirm if file was uploaded successfully
 */
...
/**
 * @remarks create a server to listen on port 4000
 */
